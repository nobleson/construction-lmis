  ...
  <div class="gradient">
    ...
    >
      ...
      <img
          ...
          alt="image slot"
        >
      <p>Regulatory Body Staffs Abuja Residence</p>
      </b-carousel-slide>

      <!-- Slides with img slot -->
      <!-- Note the classes .d-block and .img-fluid to prevent browser default image alignment -->
      <b-carousel-slide
       caption="Most papulousTraining Center"
      >
        <img
          slot="img"
          class="d-block img-fluid w-100"
          ...
          alt="image slot"
        >
        <p>The most populous and thier Training Staffs</p>
      </b-carousel-slide>

      <!-- Slide with blank fluid image to maintain slide aspect ratio -->
      <b-carousel-slide caption="Blank Image" img-blank img-alt="Blank image">
        <p>
          Next program sessions
        </p>
      </b-carousel-slide>
    </b-carousel>  
    </div>
...
<div class="gradient">
        ...
        <mdb-card :class="['gradient-card', gradient2 && 'show']" @click.native="gradient2 = true" v-on-clickaway="away2">
          <div class="d-flex d-inline-flex">
            <div class="card-image"  style="background-image: url()">
              <a>
                <mdb-mask waves class="text-green d-flex h-100 " >
